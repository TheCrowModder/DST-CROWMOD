...
return {
	ACTIONFAIL =
	{
        ...
        {
            MOUNTED = "too high.",
            HASPET = "don't need another.",
        },
		SHAVE =
		{
			AWAKEBEEFALO = "hell no.",
			GENERIC = "screw it, im gonna try later",
			NOBITS = "no hair to shave.",
            REFUSE = "only_used_by_woodie",
		},
		STORE =
		{
			GENERIC = "put it in my stash instead.",
			NOTALLOWED = "nope",
			INUSE = "this better not take long.",
            NOTMASTERCHEF = "i may be good at cooking but not that good.",
		},
        CONSTRUCT =
        {
            INUSE = "someone beat me to it.",
            NOTALLOWED = "just no",
            EMPTY = "yeah try again when you got more",
            MISMATCH = "avccvnfsskn,ahdljm, wrong stuffs.",
        },
		RUMMAGE =
		{	
			GENERIC = "maybe another day",
			INUSE = "yeah, maybe not",
            NOTMASTERCHEF = "im the best chef but still a crow",
		},
		UNLOCK =
        {
        	WRONGKEY = "my beak might be better.",
        },
		USEKLAUSSACKKEY =
        {
        	WRONGKEY = "that's not exactly right",
        	KLAUS = "NOT RIGHT NOW",
			QUAGMIRE_WRONGKEY = "nah",
        },
		ACTIVATE = 
		{
			LOCKED_GATE = "really???",
        ...
        COOK =
        {
            GENERIC = "i guess i'll wait",
            INUSE = "get tf away man",
            TOOFAR = "might wanna walk closer for that.",
        },
        ...
        GIVE =
        {
            ...
            SLEEPING = "nice nest.",
            BUSY = "give me a minute",
            ABIGAILHEART = "why did i even try",
            GHOSTHEART = "maybe i shouldn't",
            NOTGEM = "nope that won't fit, i tried.",
            WRONGGEM = "apparently the game doesn't like this gem.",
            NOTSTAFF = "too bad lmao",
            MUSHROOMFARM_NEEDSSHROOM = "use a damn mushroom",
            MUSHROOMFARM_NEEDSLOG = "use a damn living log!",
            SLOTFULL = "too bad it's full",
            FOODFULL = "already packed",
            NOTDISH = "me personally would enjoy it, not him",
            DUPLICATE = "know it!",
            NOTSCULPTABLE = "i wouldn't try it.",
            NOTATRIUMKEY = "stop trying to fight him, you're not even doing it right",
            CANTSHADOWREVIVE = "my friend isn't coming back... yet.",
            WRONGSHADOWFORM = "try a 9 piece puzzle before trying again.",
            NOMOON = "WHERE'S THE DAMN MOON???",
			PIGKINGGAME_MESSY = "clean up, geez",
			PIGKINGGAME_DANGER = "i wouldn't try it",
			PIGKINGGAME_TOOLATE = "it's too late for that now.",
        },
        GIVETOPLAYER =
        {
            FULL = "drop your 1 flint or whatever you dont need.",
            DEAD = "dead man don't need no stuff is what my father used to say",
            SLEEPING = "he's too eepy",
            BUSY = "give me a dang minute",
        },
        GIVEALLTOPLAYER =
        {
            FULL = "drop your 1 flint or whatever you dont need.",
        ...
        WRITE =
        {
            GENERIC = "it's fine as it is",
            INUSE = "this town ain't big enough for 2 scribblers.",
        },
        DRAW =
        {
            NOIMAGE = "i need a referance dummy",
        },
        CHANGEIN =
        {
            GENERIC = "i really don't right now",
            BURNING = "try again after we're not in danger",
            INUSE = "im already too stylish",
        },
        ATTUNE =
        {
            NOHEALTH = "please, i cant take it",
        },
        MOUNT =
        {
            TARGETINCOMBAT = "yeah they're maybe a little busy",
            INUSE = "GET OFF",
        },
        SADDLE =
        {
            TARGETINCOMBAT = "yeah they're a little angry",
        },
        TEACH =
        {
            --Recipes/Teacher
            KNOWN = "know iT!",
            CANTLEARN = "can't learn about it",

            --MapRecorder/MapExplorer
            WRONGWORLD = "wrong map for some otherworldly place",
        },
        WRAPBUNDLE =
        {
            EMPTY = "wrapping time comes back from commerical when i have something",
        },
        PICKUP =
        {
			RESTRICTION = "i'm not qualifyed.",
			INUSE = "science is a bitch.",
        },
        SLAUGHTER =
        {
            TOOFAR = "gone",
        ...
        REPLATE =
        {
            MISMATCH = "different thinghy!!!", 
            SAMEDISH = "nopity nope", 
        },
        SAIL =
        {
        	REPAIR = "it's too good!",
        },
        ROW_FAIL =
        {
            BAD_TIMING0 = "too soon dummy",
            BAD_TIMING1 = "closer but no cigar",
            BAD_TIMING2 = "dang it",
        },
        LOWER_SAIL_FAIL =
        {
            "uh oh",
            "FIX IT",
            "failure is prominent on this ship",
        },
        BATHBOMB =
        {
            GLASSED = "glassy.",
	...
	ANNOUNCE_BOAT_LEAK = "oh crap",
	ANNOUNCE_BOAT_SINK = "I DON'T ACTUALLY KNOW HOW TO FLY PLEASE!",
	ANNOUNCE_DIG_DISEASE_WARNING = "it's starting to improve",
	ANNOUNCE_PICK_DISEASE_WARNING = "uh oh, i don't think that's good.",
	ANNOUNCE_ADVENTUREFAIL = "i'll have to try, try again. like my father said",
    ANNOUNCE_MOUNT_LOWHEALTH = "heal it or something! im not a bioligist",
	...
	ANNOUNCE_BEES = "my friends are not my friends",
	ANNOUNCE_BOOMERANG = "i don't have hands so i can't really blame mmyself",
	ANNOUNCE_CHARLIE = "i start to know you more and more charlie.",
	ANNOUNCE_CHARLIE_ATTACK = "please go away, that's like 50% of my health",
	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific 
	ANNOUNCE_COLD = "i don't have a nest",
	ANNOUNCE_HOT = "i need a cold soda... or a cool hat",
	ANNOUNCE_CRAFTING_FAIL = "try again when you have more dummy",
	ANNOUNCE_DEERCLOPS = "i hate deerclops.",
	ANNOUNCE_CAVEIN = "rock party!!!",
	ANNOUNCE_ANTLION_SINKHOLE = 
	{
		"earthquakes are not my favorite thing",
		"uh oh",
		"i hate this",
	},
	ANNOUNCE_ANTLION_TRIBUTE =
	{
        ...
        "please don't kill me summer is too hard",
        "i used to eat this guy, now i'm giving him tribute.",
	},
	...
	ANNOUNCE_EAT =
	{
		GENERIC = "my owner's food wasn't as good as this.",
		PAINFUL = "my owner would serve better",
		SPOILED = "i want to throw up",
		STALE = "the voices dont like that",
		INVALID = "I can't eat that!",
        YUCKY = "nope that's terrible",
    ...
    ANNOUNCE_ENCUMBERED =
    {
        "this is quite easy i'm just avoiding mining",
        "sometimes i think i should do this for a job",
        "geez this is easier than i thought",
        "i'm just going slow to avoid collecting berries",
        "this is taking wwwaaaaaaayyyy too long",
        "i'm getting really bored",
        "this is debilitating",
        "next time i'm gonna do a ruin rush",
        "can't wolfgang do this???",
    },
    ...
    ANNOUNCE_RUINS_RESET = "the voices are back!!!",
    ANNOUNCE_SNARED = "MY LEGS",
    ANNOUNCE_REPELLED = "shielded!",
	ANNOUNCE_ENTER_DARK = "dark as me... get me out.",
	ANNOUNCE_ENTER_LIGHT = "thhhaat's better",
	ANNOUNCE_FREEDOM = "finally. i'm free",
	ANNOUNCE_HIGHRESEARCH = "i'm a smart boy",
	ANNOUNCE_HOUNDS = "i don't like whatever that was",
	ANNOUNCE_WORMS = "WORMS ARE IN THE FLOORS",
	ANNOUNCE_HUNGRY = "fill me please",
	ANNOUNCE_HUNT_BEAST_NEARBY = "i know a frève when i see it",
	ANNOUNCE_HUNT_LOST_TRAIL = "no frèves today",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "frog rains... moosegoose... NOW THIS?",
	ANNOUNCE_INV_FULL = "too much",
	ANNOUNCE_KNOCKEDOUT = "ouchies oof ow",
	ANNOUNCE_LOWRESEARCH = "i could've learned more in preschool",
	ANNOUNCE_MOSQUITOS = "dang it. too much in texas, too much in here.",
    ANNOUNCE_NOWARDROBEONFIRE = "now all my clothes are burned.",
    ANNOUNCE_NODANGERGIFT = "christmas can wait...",
    ANNOUNCE_NOMOUNTEDGIFT = "i should probably get off of this smelly thing first",
	ANNOUNCE_NODANGERSLEEP = "i should probably either die or not die first",
	ANNOUNCE_NODAYSLEEP = "i like night lights but this ain't it cheif",
	ANNOUNCE_NODAYSLEEP_CAVE = "i ain't sleepy!",
	ANNOUNCE_NOHUNGERSLEEP = "I REALLY NEED TO EAT BEFORE I DO THIS PLEASE",
	ANNOUNCE_NOSLEEPONFIRE = "it's all your flaut.",
	ANNOUNCE_NODANGERSIESTA = "i'll wait till i die or not",
	ANNOUNCE_NONIGHTSIESTA = "not time siesta time",
	ANNOUNCE_NONIGHTSIESTA_CAVE = "too cold and dark down here.",
	ANNOUNCE_NOHUNGERSIESTA = "give me some food first",
	ANNOUNCE_NODANGERAFK = "UHHHHH",
	ANNOUNCE_NO_TRAP = "pretty easy",
	ANNOUNCE_PECKED = "NOT BY MY OWN BROTHER",
	ANNOUNCE_QUAKE = "ce n'est pas bon du tout",
	ANNOUNCE_RESEARCH = "as my french teacher said, ferme ta gueule... whatever that means",
	ANNOUNCE_SHELTER = "trees are the umbrellas of the poor",
	ANNOUNCE_THORNS = "augh",
	ANNOUNCE_BURNT = "if  i get hotter i'll burn!",
	ANNOUNCE_TORCH_OUT = "ooohhh shit",
	ANNOUNCE_THURIBLE_OUT = "no more.",
	ANNOUNCE_FAN_OUT = "it's gone byebye",
    ANNOUNCE_COMPASS_OUT = "i don't even know how you break a compass",
	ANNOUNCE_TRAP_WENT_OFF = "uh oh",
	ANNOUNCE_UNIMPLEMENTED = "AUGH! IT ISNT READY YET DUMMY",
	ANNOUNCE_WORMHOLE = "fleshy.",
	ANNOUNCE_TOWNPORTALTELEPORT = "science is relative",
	ANNOUNCE_CANFIX = "\nmaybe i can fix this i have no idea",
	ANNOUNCE_ACCOMPLISHMENT = "yippie",
	ANNOUNCE_ACCOMPLISHMENT_DONE = "im so cool",	
	ANNOUNCE_INSUFFICIENTFERTILIZER = "i bet he's still hungry",
	ANNOUNCE_TOOL_SLIP = "i don't have hands so that was inevitable",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "HAHA!!!!! GO AWAY GOD!!",
	ANNOUNCE_TOADESCAPING = "toad is not interested.",
	ANNOUNCE_TOADESCAPED = "whoops.",


	ANNOUNCE_DAMP = "tasty yummy water.",
	ANNOUNCE_WET = "i'm damp. this is your fault",
	ANNOUNCE_WETTER = "jesus christ i need a towel",
	ANNOUNCE_SOAKED = "yeah i need multiple towels now this sucks",

	ANNOUNCE_WASHED_ASHORE = "somehow i made it",

    ANNOUNCE_DESPAWN = "11:58 9/22 2056 SUNDAY!!!!",
	ANNOUNCE_BECOMEGHOST = "Caw.",
	ANNOUNCE_GHOSTDRAIN = "uh oh",
	ANNOUNCE_PETRIFED_TREES = "the voices sense a friend",
	ANNOUNCE_KLAUS_ENRAGE = "no presents this year.",
	ANNOUNCE_KLAUS_UNCHAINED = "shit.",
	ANNOUNCE_KLAUS_CALLFORHELP = "CHEATER CHEATER PUMPKIN EATER",

	ANNOUNCE_MOONALTAR_MINE =
	{
		GLASS_MED = "somethings in there",
		GLASS_LOW = "almost got it.",
		GLASS_REVEAL = "huh.",
		IDOL_MED = "something.",
		IDOL_LOW = "almost got it out",
		IDOL_REVEAL = "hmm.",
		SEED_MED = "stuff in the stuff",
		SEED_LOW = "it's getting out",
		SEED_REVEAL = "yup.",
	},

    --hallowed nights
    ANNOUNCE_SPOOKED = "the voices are louder",
	ANNOUNCE_BRAVERY_POTION = "the voices are calmer",
	ANNOUNCE_MOONPOTION_FAILED = "guess it didnt work.",

    --lavaarena event
    ANNOUNCE_REVIVING_CORPSE = "i'm sure you dont want this but too bad",
    ANNOUNCE_REVIVED_OTHER_CORPSE = "nice.",
    ANNOUNCE_REVIVED_FROM_CORPSE = "i'm not paying the hospital bill",

    ANNOUNCE_FLARE_SEEN = "flares... hm.",
    ANNOUNCE_OCEAN_SILHOUETTE_INCOMING = "sea monsters... better than seamen",
    ...
    --quagmire event
    QUAGMIRE_ANNOUNCE_NOTRECIPE = "nope.",
    QUAGMIRE_ANNOUNCE_MEALBURNT = "man...",
    QUAGMIRE_ANNOUNCE_LOSE = "uh oh. the voices don't like that",
    QUAGMIRE_ANNOUNCE_WIN = "time to go back",
    ...
    ANNOUNCE_ATTACH_BUFF_ELECTRICATTACK    = "well this is good!",
    ANNOUNCE_ATTACH_BUFF_ATTACK            = "HAHAHAHAHA!",
    ANNOUNCE_ATTACH_BUFF_PLAYERABSORPTION  = "im some buff stuff!",
    ANNOUNCE_ATTACH_BUFF_WORKEFFECTIVENESS = "time to chop and mine!",
    ANNOUNCE_ATTACH_BUFF_MOISTUREIMMUNITY  = "i love dryers!",
    
    ANNOUNCE_DETACH_BUFF_ELECTRICATTACK    = "no more...",
    ANNOUNCE_DETACH_BUFF_ATTACK            = "back to scrawny legs and no arms...",
    ANNOUNCE_DETACH_BUFF_PLAYERABSORPTION  = "awww... could i get another?",
    ANNOUNCE_DETACH_BUFF_WORKEFFECTIVENESS = "back to sleeping on the couch.",
    ANNOUNCE_DETACH_BUFF_MOISTUREIMMUNITY  = "oh no i'm gonna get wet!",
	...
	BATTLECRY =
	{
		GENERIC = "let's hope i don't die",
		PIG = "sorry dude!",
		PREY = "HAHAHA PREPARE FOR DEATH",
		SPIDER = "this will be easy.",
		SPIDER_WARRIOR = "i hate these dudes.",
		DEER = "doe dear with miss it's dear doe",
	},
	COMBAT_QUIT =
	{
		GENERIC = "haha, i won... i think...",
		PIG = "i guess i'll stop killing you",
		PREY = "dang it",
		SPIDER = "guess i'll stop",
		SPIDER_WARRIOR = "nope nope nope",
	},
	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "don't like this don't like this",
        MULTIPLAYER_PORTAL_MOONROCK = "i just wanna get out of here",
        MOONROCKIDOL = "religeon of the moon?",
        CONSTRUCTION_PLANS = "science time!",

        ANTLION =
        {
            GENERIC = "bonjour mon ennemi, comment vas-tu.",
            VERYHAPPY = "he's happy... for now.",
            UNHAPPY = "give him like a rock or a twig",
        },
        ANTLIONTRINKET = "i think my old friend might like this",
        SANDSPIKE = "ouch off ow",
        SANDBLOCK = "sandy.",
        GLASSSPIKE = "i don't want to be a kabob.",
        GLASSBLOCK = "huh.",
        ABIGAIL_FLOWER =
        {
            GENERIC ="can we grow more?",
            LONG = "looks a bit funny.",
            MEDIUM = "the voices are interested",
            SOON = "the voices want me to have it",
            HAUNTED_POCKET = "uhhhhhhh",
            HAUNTED_GROUND = "i don't much like this",
        },

        BALLOONS_EMPTY = "haha, twitter users",
        BALLOON = "i like to peck them.",
        ...
        BERNIE_ACTIVE = "i used to have a teddy bear. maybe they were friends",
        BERNIE_BIG = "willow gets more and more weird each day",

        BOOK_BIRDS = "i think i already know about them.",
        BOOK_TENTACLES = "NO.",
        BOOK_GARDENING = "now this is the only useful one.",
        BOOK_SLEEP = "just get a panflute!",
        BOOK_BRIMSTONE = "this one sucks",
        ...
        WILLOW =
        {
            GENERIC = "%s leave the server",
            ATTACKER = "%s leave the server",`
            MURDERER = "%s leave the server,
            REVIVER = "%s leave the server",
            GHOST = "%s leave the server",
            FIRESTARTER = "%s leave the server",
        },
        WENDY =
        {
            GENERIC = "whatsup, %s!",
        ...
        WOODIE =
        {
            ...
            REVIVER = "%s, you're a power to the people",
            GHOST = "%s don't look at me!",
            BEAVER = "moose, goose, and then something that doesn rhyme",
            BEAVERGHOST = "moose, goose, and then something that doesn rhyme",
            MOOSE = "moose, goose, and then something that doesn rhyme",
            MOOSEGHOST = "moose, goose, and then something that doesn rhyme",
            GOOSE = "haha",
            GOOSEGHOST = "moose, goose, and then something that doesn rhyme",
            FIRESTARTER = "don't be a willow, %s.",
        },
        WICKERBOTTOM =
        {
